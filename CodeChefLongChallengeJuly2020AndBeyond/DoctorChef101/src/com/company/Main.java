    ...
    public static void main(String[] args) throws java.lang.Exception{
        ...
        while (t-->0){
            ...
            if (removingDubplicates==1){
                ...
                long newCount=0;
                boolean maxPointReached=false;
                for (int i=0;i<n;i++){

                    /** Case when our cure is greater than population*/
                    if (A[i]<cure && !maxPointReached){
                        newCount++;
                        continue;
                    }
                    else if (A[i]<cure && maxPointReached){
                        newCount++;
                        cure=A[i]*2;
                        A[i]=0;
                        continue;
                    ...
                    /**Case when our cure is not greater than population*/
                        ...
                        maxPointReached=true; /** From here we have to work on only increasing the cure*/
                        long totalDelievered=cure;
                        cure=totalDelievered*2;
