...
public class Main {
    ...
    public static   class Dataset1{
        ...
        /**
         * Q.1.2  To rate each salesRepresentativeID on the basis of their daily revenue (For given Date (Today let be 01-02-2020), and the whole list of datas)
         */
    ...
    public static void main(String[] args) {
        ...
        List<Dataset1> listOfDataset1=new ArrayList<>();    /** List for Table 1- Dataset 1**/
        List<Dataset2> listOfDataset2=new ArrayList<>();    /** List for Table 2- Dataset 2**/
